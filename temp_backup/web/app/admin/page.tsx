  ...
  return (
    <main className="section">
      <div className="container">
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20, paddingBottom: 16, borderBottom: "2px solid var(--color-border)" }}>
          ...
          <div style={{ display: "flex", gap: 12 }}>
            ...
            <Link href="/" target="_blank" className="btn" style={{ display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <div className="layout-grid" style={{ marginTop: 16 }}>
          ...
          <section>
            ...
            <div className="card" style={{ marginTop: 20 }}>
              <div className="card-body">
                <div style={{ fontWeight: 700, marginBottom: 12 }}>Hızlı İşlemler</div>
                <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                  <Link href="/admin/listings/new" className="btn">
                    <i className="fa-solid fa-plus" style={{ marginRight: 6 }}></i>
                    Yeni İlan Ekle
                  </Link>
                  <Link href="/admin/talep-gir" className="btn btn-outline">
                    <i className="fa-solid fa-paper-plane" style={{ marginRight: 6 }}></i>
                    Talep Gir
                  </Link>
                </div>
              </div>
