...
export default function AdminCityButtonsPage() {
  ...
  // Add page-specific styles to prevent input overflow
  useEffect(() => {
    const style = document.createElement('style');
    style.textContent = `
      .admin-city-buttons-page input.search-input {
        min-width: 0 !important;
        width: 100% !important;
        flex: 1 1 auto !important;
      }
      .admin-city-buttons-page > div > div {
        min-width: 0;
      }
    `;
  ...
  return (
    <main className="section admin-city-buttons-page">
      <div className="container">
        <div className="section-title">Şehir Butonları</div>
