...
Gayrimenkul ihtiyaçlarınız için bizimle iletişime geçebilirsiniz. Profesyonel ekibimiz size en kısa sürede dönüş yapacaktır.
    ...
    try {
      for (const page of defaultPages) {
        ...
        const exists = checkRes.ok && (await checkRes.text());
      ...
      alert('Sistem sayfaları başarıyla oluşturuldu!');
      loadPages();
    } catch (error) {
      console.error('Sayfa oluşturma hatası:', error);
      alert('Sayfa oluşturma sırasında hata oluştu.');
    }
  };
    ...
    <main className="section">
      <div className="container">
        ...
        <div style={{ display: "flex", gap: 12, marginBottom: 16, flexWrap: "wrap" }}>
          ...
          <button 
            className="btn" 
            onClick={initSystemPages}
            style={{ background: "#10b981", borderColor: "#10b981" }}
          >
            <i className="fa-solid fa-file-plus"></i> Sistem Sayfalarını Oluştur
          </button>
        </div>
